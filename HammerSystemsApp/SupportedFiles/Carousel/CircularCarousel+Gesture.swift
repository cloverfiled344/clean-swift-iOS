        ...
        if scrollEnabled && numberOfItems > 0 {
            ...
            case .changed:
                ...
                if !wrapEnabled && bounceEnabled {
                    factor = 1.0 - min(abs(scrollOffset - clampedOffset(scrollOffset)),
                                       CircularCarouselConstants.bounceDist) / CircularCarouselConstants.bounceDist
                }
                ...
                pscrollOffset = scrollOffset - ((translation - previousTranslation) *
                                                    factor *
                                                    offsetMultiplier / itemWidth)
